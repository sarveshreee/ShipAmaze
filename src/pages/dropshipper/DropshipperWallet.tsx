    ...
    <div className="animate-fade-in-up">
      ...
      <div className="rounded-xl p-6 mb-6 text-primary-foreground" style={{ background: "linear-gradient(135deg, hsl(var(--color-primary)), hsl(var(--color-secondary)))" }}>
        ...
        <div className="flex gap-3 mt-4">
          <Button className="bg-card/20 hover:bg-card/30 text-primary-foreground border-0" onClick={() => toast.success("Funds added successfully")}><Plus className="h-4 w-4 mr-2"/>Add Funds</Button>
          <Button variant="outline" className="border-card/30 text-primary-foreground hover:bg-card/10" onClick={() => toast.info("Withdrawal request submitted")}><ArrowUpRight className="h-4 w-4 mr-2"/>Withdraw</Button>
        </div>
      </div>
