...
import { AlertTriangle, Phone, MessageSquare, RotateCcw, ArrowRight } from "lucide-react";
          ...
          <div key={n.awb} className="rounded-lg bg-card shadow-card p-4 hover:shadow-card-md transition-shadow">
            <div className="flex flex-wrap items-start gap-4">
              ...
              <div className="flex items-center gap-2">
                {n.status === 'Active' && (
                  <>
                    <Button size="sm" className="text-xs h-8 bg-primary text-primary-foreground gap-1">
                      <ArrowRight className="h-3 w-3" />Re-attempt
                    </Button>
                    <Button size="sm" variant="outline" className="text-xs h-8 gap-1">
                      <Phone className="h-3 w-3" />Call
                    </Button>
                    <Button size="sm" variant="outline" className="text-xs h-8 text-danger border-danger/30 hover:bg-danger-light gap-1">
