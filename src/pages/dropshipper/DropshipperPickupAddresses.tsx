  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button onClick={() => setShowForm(!showForm)} className="bg-primary text-primary-foreground hover:bg-primary-dark">
      ...
      {showForm && (
        <div className="rounded-lg bg-card shadow-card p-6 mb-6 border-2 border-primary/20 animate-fade-in-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div><Label>Address Label</Label><Input placeholder="e.g. Main Warehouse" /></div>
            ...
            <div className="sm:col-span-2"><Label>Address Line 1</Label><Input placeholder="Building, Street" /></div>
          ...
          <div className="flex gap-2 mt-4">
            <Button className="bg-primary text-primary-foreground hover:bg-primary-dark">Save Address</Button>
          ...
          <div key={a.id} className={cn(
            ...
            <div className="space-y-1.5 text-sm">
              <p className="flex items-center gap-2 text-text-secondary">
                <User className="h-3.5 w-3.5 text-text-muted" />{a.contactName}
              </p>
              <p className="flex items-center gap-2 text-text-secondary">
                <Phone className="h-3.5 w-3.5 text-text-muted" />{a.phone}
              </p>
            ...
            <div className="flex gap-2 mt-4 pt-3 border-t border-border">
              ...
              {!a.isDefault && (
                <>
                  ...
                  <Button size="sm" variant="ghost" className="text-xs h-7 text-danger hover:text-danger hover:bg-danger-light">
