...
import { Eye, EyeOff, Truck, Package, MapPin, ArrowRight } from "lucide-react";
        ...
        <div className="w-full max-w-[420px] animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="admin@shipflow.in" className="h-11" />
            </div>
            <div className="space-y-1.5">
          ...
          <div className="mt-6 rounded-xl bg-surface-2 p-4 text-xs text-text-muted space-y-1 border border-border">
            <p className="font-medium text-text-secondary flex items-center gap-1.5">
              <Package className="h-3.5 w-3.5" /> Demo credentials
            </p>
