...
import {
  ...
  Hash, Weight, IndianRupee, Calendar, Box, Copy, RefreshCw, ArrowLeft
} from "lucide-react";
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-background">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-text-muted">Order ID: {orderId}</p>
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-semibold text-text-primary">Order {order.id}</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        {/* Customer + Shipment side by side on desktop */}
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pb-4">
            <Button variant="outline" className="gap-2 h-10 text-text-secondary hover:text-primary hover:border-primary/30" onClick={() => { printShippingLabel(order); toast.success("Printing label..."); }}>
